...
import 'package:flutter_sado_ecommerce/theme/dark_theme.dart';
import 'package:flutter_sado_ecommerce/theme/light_theme.dart';
import 'package:flutter_sado_ecommerce/utill/app_constants.dart';
import 'package:flutter_sado_ecommerce/view/screen/splash/splash_screen.dart';
...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<RoomListProvider>()),
