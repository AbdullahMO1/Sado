...
import 'package:flutter_sado_ecommerce/data/model/response/user_info_model.dart';
  ...
  Future<ApiResponse> getAllAddress() async {
    try {
      final response = await dioClient!.get(
          '${AppConstants.addressListUri}?guest_id=${Provider.of<AuthProvider>(Get.context!, listen: false).getGuestToken()}');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> removeAddressByID(int? id) async {
    try {
      final response = await dioClient!.delete(
          '${AppConstants.removeAddressUri}?address_id=$id&guest_id=${Provider.of<AuthProvider>(Get.context!, listen: false).getGuestToken()}');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
