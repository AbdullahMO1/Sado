...
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/proced_button.dart';
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/shipping_details_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/offline_payment/widget/offline_card.dart';
...
class OfflinePaymentScreen extends StatefulWidget {
  ...
  const OfflinePaymentScreen(
      {Key? key, required this.payableAmount, required this.callback})
      : super(key: key);
                  ...
                  children: [
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                    ...
                                    child: OfflineCard(
                                        offlinePaymentModel: orderProvider
                                            .offlinePaymentModel!
                    ...
                    ListView.builder(
                        ...
                        itemCount: orderProvider
                            .offlinePaymentModel!
                            .offlineMethods![
                                orderProvider.offlineMethodSelectedIndex]
                            .methodInformations
                            ?.length,
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: CustomTextField(
                              controller:
                                  orderProvider.inputFieldControllerList[index],
                              required: orderProvider
                                      .offlinePaymentModel!
                                      .offlineMethods![orderProvider
                                          .offlineMethodSelectedIndex]
                                      .methodInformations?[index]
                                      .isRequired ==
                                  1,
                              labelText:
                                  '${orderProvider.offlinePaymentModel!.offlineMethods![orderProvider.offlineMethodSelectedIndex].methodInformations?[index].customerInput}'
                                      .replaceAll('_', ' ')
                                      .capitalize(),
                              hintText:
                                  '${orderProvider.offlinePaymentModel!.offlineMethods![orderProvider.offlineMethodSelectedIndex].methodInformations?[index].customerPlaceholder}'
                                      .replaceAll('_', ' ')
                                      .capitalize(),
                            ),
                          );
