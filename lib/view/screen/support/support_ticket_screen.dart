...
import 'package:flutter_sado_ecommerce/data/model/response/support_ticket_model.dart';
...
import 'package:flutter_sado_ecommerce/view/screen/support/support_ticket_item.dart';
import 'package:flutter_sado_ecommerce/view/screen/support/support_ticket_shimmer.dart';
import 'package:flutter_sado_ecommerce/view/screen/support/support_ticket_type_widget.dart';
...
class _SupportTicketScreenState extends State<SupportTicketScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Provider.of<AuthProvider>(context, listen: false)
              .isLoggedIn()
          ? SizedBox(
              height: 70,
              child: InkWell(
