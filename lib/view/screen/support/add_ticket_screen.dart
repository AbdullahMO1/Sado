...
import 'package:flutter_sado_ecommerce/data/model/body/support_ticket_body.dart';
...
import 'package:flutter_sado_ecommerce/view/screen/support/priority_bottom_sheet.dart';
import 'package:flutter_sado_ecommerce/view/screen/support/support_ticket_type_widget.dart';
import 'package:provider/provider.dart';

class AddTicketScreen extends StatefulWidget {
  final TicketModel ticketModel;
  const AddTicketScreen({Key? key, required this.ticketModel})
      : super(key: key);
