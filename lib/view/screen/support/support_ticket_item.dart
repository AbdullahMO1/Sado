...
import 'package:flutter_sado_ecommerce/view/screen/support/support_conversation_screen.dart';
import 'package:flutter_slidable/flutter_slidable.dart';
import 'package:provider/provider.dart';

class SupportTicketWidget extends StatelessWidget {
  final SupportTicketModel supportTicketModel;
  const SupportTicketWidget({Key? key, required this.supportTicketModel})
      : super(key: key);
