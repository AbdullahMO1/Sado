...
import 'package:flutter_sado_ecommerce/view/basewidget/remove_wish_list_bottom_sheet.dart';
import 'package:flutter_sado_ecommerce/view/screen/compare/controller/compare_controller.dart';
import 'package:flutter_sado_ecommerce/view/screen/compare/widget/custom_top_sheet.dart';
...
class CompareCard extends StatelessWidget {
  ...
  final int? compareId;
  const CompareCard({Key? key, required this.product, this.compareId})
      : super(key: key);
