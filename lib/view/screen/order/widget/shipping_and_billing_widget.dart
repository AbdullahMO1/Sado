...
import 'package:flutter_sado_ecommerce/view/screen/order/widget/icon_with_text_row.dart';
import 'package:provider/provider.dart';

class ShippingAndBillingWidget extends StatelessWidget {
  final OrderProvider orderProvider;
  const ShippingAndBillingWidget({Key? key, required this.orderProvider})
      : super(key: key);
