...
import 'package:flutter_sado_ecommerce/data/model/response/order_details.dart';
...
import 'package:flutter_sado_ecommerce/view/screen/auth/widget/otp_verification_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/refunded_status_bottom_sheet.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/review_dialog.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/refund_request_bottom_sheet.dart';
...
class _OrderDetailsWidgetState extends State<OrderDetailsWidget> {
  String _getTaxText(String taxModel) {
    if (taxModel.toLowerCase() == 'include') {
      // إذا كانت كلمة الضريبة 'include' فيمكنك ترجمتها إلى 'شامل'
      return getTranslated('inclusive', context)!;
    } else {
      // إذا كانت كلمة الضريبة غير 'include' فيمكنك استخدامها كما هي
      return taxModel;
    }
  }
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            widget.orderDetailsModel.productDetails!.taxModel ==
                                ...
                                : Text(
                                    '(${getTranslated('tax', context)} ${_getTaxText(widget.orderDetailsModel.productDetails!.taxModel ?? '')})',
                                    style: titilliumRegular.copyWith(
                                        color: ColorResources.hintTextColor,
                                        fontSize: Dimensions.fontSizeDefault),
                                  ),
