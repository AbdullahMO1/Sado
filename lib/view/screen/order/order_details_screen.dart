...
import 'package:flutter_sado_ecommerce/view/basewidget/image_diaglog.dart';
import 'package:flutter_sado_ecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/home/shimmer/order_details_shimmer.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/cal_chat_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/cancel_and_support_center.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/order_details_top_portion_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/ordered_product_list.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/payment_info.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/seller_section.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/shipping_and_billing_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/order/widget/shipping_info.dart';
...
import 'package:flutter_sado_ecommerce/view/basewidget/amount_widget.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  void _loadData(BuildContext context) async {
    if (Provider.of<AuthProvider>(context, listen: false).isLoggedIn() &&
      ...
      await Provider.of<OrderProvider>(Get.context!, listen: false)
          .trackYourOrder(
              orderId: widget.orderId.toString(), phoneNumber: widget.phone);
      await Provider.of<OrderProvider>(Get.context!, listen: false)
          .getOrderFromOrderId(widget.orderId.toString());
    }
  }
