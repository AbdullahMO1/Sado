...
import 'package:flutter_sado_ecommerce/view/screen/home/model/more_store_model.dart';
import 'package:flutter_sado_ecommerce/view/screen/shop/shop_screen.dart';
...
class _MoreStoreWidgetState extends State<MoreStoreWidget> {
  ...
  Widget build(BuildContext context) {
    if (widget.moreStore.shop!.vacationEndDate != null) {
      ...
      if (difference >= 0 &&
          widget.moreStore.shop!.vacationStatus == 1 &&
          startDate <= 0) {
        vacationIsOn = true;
      } else {
        vacationIsOn = false;
      ...
      if (kDebugMode) {
        print(
            '------=>${widget.moreStore.shop!.name}${widget.moreStore.shop!.vacationEndDate}/${widget.moreStore.shop!.vacationStartDate}${vacationIsOn.toString()}/${difference.toString()}/${startDate.toString()}');
      }
    }
