                              ...
                              SizedBox(
                                ...
                                child: CarouselSlider.builder(
                                  ...
                                  itemBuilder: (context, index, _) {
                                    String colorString = bannerProvider
                                                .mainBannerList![index]
                                                .backgroundColor !=
                                            null
                                        ? '0xff${bannerProvider.mainBannerList![index].backgroundColor!.substring(1, 7)}'
                                        : '0xFF424242';
                      ...
                      children: bannerProvider.mainBannerList!.map((banner) {
                        ...
                        return index == bannerProvider.currentIndex
                            ...
                            : Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      const Color(0xff1B7FED).withOpacity(0.2),
