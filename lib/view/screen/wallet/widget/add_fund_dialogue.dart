...
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/custom_check_box.dart';
                            ...
                            child: CustomButton(
                              ...
                              onTap: () {
                                if (orderProvider
                                  ...
                                  orderProvider.setDigitalPaymentMethodName(
                                      0,
                                ...
                                if (inputAmountController.text.trim().isEmpty) {
                                  ...
                                  showCustomSnackBar(
                                      '${getTranslated('please_input_amount', context)}',
                                      context);
                                } else if (orderProvider.paymentMethodIndex ==
                                    -1) {
                                  showCustomSnackBar(
