...
import 'package:flutter_sado_ecommerce/data/model/response/social_login_model.dart';
              ...
              Provider.of<SplashProvider>(context, listen: false)
                  ...
                  ? InkWell(
                      onTap: () async {
                        ...
                        if (context.mounted) {}
                        if (Provider.of<GoogleSignInProvider>(Get.context!,
                                    listen: false)
                                .googleAccount !=
                            null) {
                          id = Provider.of<GoogleSignInProvider>(Get.context!,
                                  listen: false)
                              .googleAccount!
                              .id;
                          email = Provider.of<GoogleSignInProvider>(
                                  Get.context!,
                                  listen: false)
                              .googleAccount!
                              .email;
                          token = Provider.of<GoogleSignInProvider>(
                                  Get.context!,
                                  listen: false)
                              .auth
                              .accessToken;
                  ...
                  ? InkWell(
                      onTap: () async {
                        await Provider.of<FacebookLoginProvider>(context,
                            ...
                            .login();
                        String? id, token, email, medium;
                        if (Provider.of<FacebookLoginProvider>(Get.context!,
                                    listen: false)
                                .userData !=
                            null) {
                          id = Provider.of<FacebookLoginProvider>(Get.context!,
                                  listen: false)
                              .result
                              .accessToken!
                              .userId;
                          email = Provider.of<FacebookLoginProvider>(
                                  Get.context!,
                                  listen: false)
                              .userData!['email'];
                          token = Provider.of<FacebookLoginProvider>(
                                  Get.context!,
                                  listen: false)
                              .result
                              .accessToken!
