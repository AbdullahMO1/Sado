...
import 'package:flutter_sado_ecommerce/data/model/body/login_model.dart';
...
import 'package:flutter_sado_ecommerce/view/screen/auth/forget_password_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/auth/widget/mobile_verify_screen.dart';
            ...
            Consumer<AuthProvider>(builder: (context, authProvider, _) {
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(getTranslated('continue_as', context)!,
                      style: titleRegular.copyWith(
                        color: ColorResources.getPrimary(context),
                        decoration: TextDecoration.underline,
                        decorationColor: ColorResources.getPrimary(context),
                      )),
                ),
              );
            }),
