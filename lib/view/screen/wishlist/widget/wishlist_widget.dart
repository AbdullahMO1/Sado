...
import 'package:flutter_sado_ecommerce/view/basewidget/remove_from_wishlist_bottom_sheet.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/product_details_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/wishlist/model/wishlist_model.dart';
import 'package:provider/provider.dart';

class WishListWidget extends StatelessWidget {
  final WishlistModel? wishlistModel;
  final int? index;
  const WishListWidget({Key? key, this.wishlistModel, this.index})
      : super(key: key);
