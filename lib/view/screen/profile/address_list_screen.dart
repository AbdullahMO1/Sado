...
import 'package:flutter_sado_ecommerce/view/basewidget/remove_address_bottom_sheet.dart';
import 'package:flutter_sado_ecommerce/view/screen/address/add_new_address_screen.dart';
      ...
      body: Consumer<ProfileProvider>(
        builder: (context, profileProvider, child) {
          return !profileProvider.isLoading
              ? profileProvider.shippingAddressList.isNotEmpty
                  ? RefreshIndicator(
                      onRefresh: () async {
                        Provider.of<ProfileProvider>(context, listen: false)
                            .initAddressTypeList(context);
