...
import 'package:flutter_sado_ecommerce/view/basewidget/delete_account_bottom_sheet.dart';
...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  _updateUserAccount() async {
    ...
    if (Provider.of<ProfileProvider>(context, listen: false)
      ...
      showCustomSnackBar(
        getTranslated('password_complexity_requirements', context),
        context,
      );
    } else {
      ...
      updateUserInfoModel.email = _emailController.text; // Add this line
