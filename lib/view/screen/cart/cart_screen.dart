...
import 'package:flutter_sado_ecommerce/view/basewidget/guest_dialog.dart';
import 'package:flutter_sado_ecommerce/view/basewidget/no_internet_screen.dart';
import 'package:flutter_sado_ecommerce/view/basewidget/not_logged_in_bottom_sheet.dart';
import 'package:flutter_sado_ecommerce/view/basewidget/show_custom_snakbar.dart';
import 'package:flutter_sado_ecommerce/view/screen/cart/widget/cart_page_shimmer.dart';
import 'package:flutter_sado_ecommerce/view/screen/cart/widget/cart_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/checkout/checkout_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/shipping_method_bottom_sheet.dart';
        ...
        return Scaffold(
          bottomNavigationBar: (!cart.isXyz && cartList.isNotEmpty)
              ? Consumer<SplashProvider>(builder: (context, configProvider, _) {
                  return Container(
                      height: cartList.isNotEmpty ? 140 : 0,
