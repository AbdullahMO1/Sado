...
import 'package:flutter_sado_ecommerce/data/model/body/message_body.dart';
...
import 'package:flutter_sado_ecommerce/view/screen/chat/widget/chat_shimmer.dart';
import 'package:flutter_sado_ecommerce/view/screen/chat/widget/message_bubble.dart';
                            ...
                            Positioned(
                                ...
                                child: InkWell(
                                    child: const Icon(Icons.cancel_outlined,
                                        color: Colors.red),
                                    onTap: () => chatProvider.pickMultipleImage(
                                        true,
                                        index: index))),
                          ],
                        );
