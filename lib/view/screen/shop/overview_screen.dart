...
import 'package:flutter_sado_ecommerce/view/screen/shop/widget/shop_coupon_item_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/shop/widget/shop_featured_product_list_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/shop/widget/shop_recommanded_product_list.dart';
...
class ShopOverviewScreen extends StatefulWidget {
  ...
  const ShopOverviewScreen(
      {Key? key, required this.sellerId, required this.scrollController})
      : super(key: key);
