...
class RefundBottomSheet extends StatefulWidget {
  ...
  const RefundBottomSheet(
      {Key? key, required this.product, required this.orderDetailsId})
      : super(key: key);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CustomButton(
                        ...
                        onTap: () {
                          String reason =
                              _refundReasonController.text.trim().toString();
                          if (reason.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              behavior: SnackBarBehavior.floating,
                              content: Text(
                                  getTranslated('reason_required', context)!),
                            ...
                            refundReq
                                .refundRequest(
                                    ...
                                    refundReq
                                        .refundInfoModel!.refund!.refundAmount,
                                    reason,
