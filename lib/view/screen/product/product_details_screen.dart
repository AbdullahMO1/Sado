...
import 'package:flutter_sado_ecommerce/view/screen/home/shimmer/product_details_shimmer.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/promise_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/review_section.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/seller_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/comment_section.dart'; // استيراد قسم التعليقات
...
import 'package:flutter_sado_ecommerce/view/screen/product/widget/bottom_cart_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/product_image_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/product_specification_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/product_title_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/related_product_view.dart';
import 'package:flutter_sado_ecommerce/view/screen/product/widget/youtube_video_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/shop/widget/shop_product_view_list.dart';
...
class _ProductDetailsState extends State<ProductDetails> {
  bool isReview = false;
  bool isComment = false; // متغير للتحكم في إظهار التعليقات
                        ...
                        Column(
                          children: [
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      setState(() {
                                        isReview = false;
                                        isComment = false; // عرض النظرة العامة
                                      });
                                    },
                                  ...
                                  const SizedBox(
                                      width: Dimensions.paddingSizeDefault),
                                  if (details.productDetailsModel!.roomId !=
                                      null) // تحقق من roomId
                                    InkWell(
                                      onTap: () {
                                        setState(() {
                                          isReview = false;
                                          isComment = true; // عرض التعليقات
                                        });
                                      },
                                      child: Column(children: [
                                        Container(
                            ...
                            if (isReview)
                              ...
                              CommentSection(details: details) // قسم التعليقات
                            else
                              Column(
                                children: [
