...
class ShippingMethodBottomSheetState extends State<ShippingMethodBottomSheet> {
  ...
  @override
  void initState() {
    if (Provider.of<CartProvider>(context, listen: false).shippingList !=
            null &&
        Provider.of<CartProvider>(context, listen: false)
            .shippingList!
            .isNotEmpty) {
      selectedIndex = Provider.of<CartProvider>(context, listen: false)
                                ...
                                onTap: () {
                                  Provider.of<CartProvider>(context,
                                      ...
                                      .setSelectedShippingMethod(
                                          selectedIndex, widget.sellerIndex);
