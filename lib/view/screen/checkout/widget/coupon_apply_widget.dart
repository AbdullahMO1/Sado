...
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/coupon_bottom_sheet.dart';
...
class CouponApplyWidget extends StatelessWidget {
  ...
  const CouponApplyWidget(
      {Key? key, required this.couponController, required this.orderAmount})
      : super(key: key);
