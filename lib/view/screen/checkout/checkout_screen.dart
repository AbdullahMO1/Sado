...
import 'package:flutter_sado_ecommerce/data/model/response/cart_model.dart';
...
import 'package:flutter_sado_ecommerce/view/basewidget/animated_custom_dialog.dart';
...
import 'package:flutter_sado_ecommerce/view/basewidget/custom_button_withLoading.dart';
import 'package:flutter_sado_ecommerce/view/basewidget/order_place_success_dialog.dart';
...
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/choose_payment_section.dart';
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/coupon_apply_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/shipping_details_widget.dart';
import 'package:flutter_sado_ecommerce/view/screen/checkout/widget/wallet_payment.dart';
import 'package:flutter_sado_ecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:flutter_sado_ecommerce/view/screen/offline_payment/offline_payment.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
            ...
            return Consumer<ProfileProvider>(
              ...
              return Padding(
                ...
                child: CustomButtonWithLoading(
                  ...
                  onTap: () async {
                    setState(() {
                      isLoading = true; // تحديث الحالة لتظهر عملية التحميل
                    });
                  ...
                  buttonText:
                      isLoading ? '' : '${getTranslated('proceed', context)}',
                ),
              );
            });
          });
  ...
  void _callback(bool isSuccess, String message, String orderID) async {
    if (isSuccess) {
      ...
      setState(() {
        isLoading = false; // إخفاء عملية التحميل
      });
    } else {
