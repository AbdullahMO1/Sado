import 'package:flutter_sado_ecommerce/data/model/response/language_model.dart';
import 'package:flutter_sado_ecommerce/utill/images.dart';

class AppConstants {
  static const String appName = 'Sado';
  static const String slogan = 'Shop Furniture & 3D-Design';
  static const String appVersion = '1.0';
  static const String baseUrl = 'https://sado-ksa.com';
  ...
  static const String roomListUri = '/api/v1/room-list';
  ...
  static const String addCommentUri = '/api/v1/products/add-comment';
  static const String addReplyUri = '/api/v1/products/add-reply';
  static const String likeCommentUri = '/api/v1/products/like-comment';
  static const String deleteCommentUri = '/api/v1/products/destroy-comment/';
  static const String deleteReplyUri = '/api/v1/products/destroy-reply/';
  static const String getCommentsUri = '/api/v1/products/comments/';
